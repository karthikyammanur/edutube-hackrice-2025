...
export default function Modal({ open, onClose, title, children }: ModalProps): JSX.Element | null {
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center p-4">
			...
			<div role="dialog" aria-modal="true" aria-labelledby="modal-title" className="relative z-10 w-full max-w-2xl rounded-2xl border border-border bg-white p-6 shadow-xl">
